var FrontStreetIndex = [
	...
	},
	{
		title: 'Plugins',
		url: 'plugins.html',
		tags: ['third-party', 'scripts', 'owl-carousel', 'font-awesome', 'magnific-popup', 'icons', 'modal', 'slider']
	},
	{
		title: 'JavaScript',
		url: 'javascript.html',
	...
	},
	{
		...
		tags: ['<del>', 'strike-through', '<s>', '<ins>', 'underline', '<u>', '<small>', '<strong>', '<b>', 'bold', '<em>', 'italic']
	},
	{
